...
> Last synced: 2026-04-07T12:28:53Z | Commit: 6e8aab4 | Repo: Ohanafy/OHFY-OMS
...
|---------|---------|---------------|-------------|
| CreditTrigger | Credit__c | TriggerHandler | new ClassName() |
| DeliveryTrigger | Delivery__c | TriggerHandler | new ClassName() |
| DepletionTrigger | Depletion__c | TriggerHandler | new ClassName() |
| InvoiceFeeTrigger | Invoice_Fee__c | TriggerHandler | new ClassName() |
| InvoiceItemTrigger | Invoice_Item__c | TriggerHandler | new ClassName() |
| InvoiceTrigger | Invoice__c | TriggerHandler | new ClassName() |
| PromotionItemTrigger | Promotion_Item__c | TriggerHandler | new ClassName() |
| PromotionTrigger | Promotion__c | TriggerHandler | new ClassName() |
...
| Service Locator | 6 | Classes using service locator pattern |
| Batch/Schedulable | 6 | Classes implementing batch or schedulable |
| Queueable | 3 | Classes using async queueable jobs |
...
| Metric | Count |
|--------|-------|
| Production classes | 53 |
| Test/Mock/Stub classes | 81 |
| Test-to-production ratio | 152% |

### Classes Without Apparent Test Coverage (28)

- `B_Delivery_LockDeliveries`
- `B_Invoice_LockInvoices`
- `B_Invoice_MetricUpdater`
- `AddToTruckController`
- `E_InvoiceAdjDeleter`
- `E_Invoice_StatusValidationBypass`
- `E_Invoicing_Configuration`
- `S_Deliveries`
- `CreditTriggerService`
- `DeliveryTriggerService`
- `DepletionTriggerService`
- `InvoiceTriggerService`
- `InvoiceAfterDelete`
- `InvoiceAfterInsert`
- `InvoiceAfterUpdate`
- `InvoiceBeforeDelete`
- `InvoiceBeforeInsert`
- `InvoiceBeforeUpdate`
- `InvoiceFeeTriggerService`
- `InvoiceItemTriggerService`
- `InvoiceItemAfterDelete`
- `InvoiceItemAfterInsert`
- `InvoiceItemAfterUpdate`
- `InvoiceItemBeforeDelete`
- `InvoiceItemBeforeInsert`
- `InvoiceItemBeforeUpdate`
- `PromotionTriggerService`
- `PromotionItemTriggerService`
