...
export default function SolutionTile({ loading, isInstance, solution, instances, onConnect, onDisconnect, onEnable, onDisable, tagFilters }) {
    ...
    //Ohanafy customizations
    const docUrl = get(solution, 'customFieldsMap.documentation')
    console.log(docUrl)
            ...
            <div className={classNames('tile', { loading: loading })}>
                {loading ? (
                    ...
                    <>
                        ...
                        <footer>
                             <span className="button"><Button loading={connecting} role="link" onClick={() => openInNewTab()} bgColor={ctaBgCol} fgColor={ctaFgCol}>Documentation</Button></span>
